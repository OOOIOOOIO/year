package com.sh.year.domain.goal.diary.biggoaldiary.application;
...
import com.sh.year.domain.goal.diary.biggoaldiary.domain.repository.BigGoalReviewRepository;
