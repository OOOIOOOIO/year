...
import com.sh.year.domain.smallgoal.smallgoal.api.dto.req.RuleReqDto;
...
import com.sh.year.domain.rule.rulealertinfo.domain.RuleAlertInfo;
import com.sh.year.domain.rule.rulecompleteinfo.domain.RuleCompleteInfo;
import com.sh.year.domain.rule.rulerepeatday.domain.RuleRepeatDay;
