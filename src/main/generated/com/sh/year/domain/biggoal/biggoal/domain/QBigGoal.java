package com.sh.year.domain.biggoal.biggoal.domain;
...
public class QBigGoal extends EntityPathBase<BigGoal> {
    ...
    private static final long serialVersionUID = -1518413468L;
    ...
    public final com.sh.year.domain.biggoal.review.domain.QBigGoalReview bigGoalReview;
    ...
    public final ListPath<com.sh.year.domain.smallgoal.smallgoal.domain.SmallGoal, com.sh.year.domain.smallgoal.smallgoal.domain.QSmallGoal> smallGoalList = this.<com.sh.year.domain.smallgoal.smallgoal.domain.SmallGoal, com.sh.year.domain.smallgoal.smallgoal.domain.QSmallGoal>createList("smallGoalList", com.sh.year.domain.smallgoal.smallgoal.domain.SmallGoal.class, com.sh.year.domain.smallgoal.smallgoal.domain.QSmallGoal.class, PathInits.DIRECT2);
    ...
    public QBigGoal(Class<? extends BigGoal> type, PathMetadata metadata, PathInits inits) {
        ...
        this.bigGoalReview = inits.isInitialized("bigGoalReview") ? new com.sh.year.domain.biggoal.review.domain.QBigGoalReview(forProperty("bigGoalReview"), inits.get("bigGoalReview")) : null;
