package com.sh.year.domain.goal.review.biggoalreview.domain;
...
public class QBigGoalReview extends EntityPathBase<BigGoalReview> {
    ...
    private static final long serialVersionUID = -966098236L;
    ...
    public final com.sh.year.domain.goal.goal.biggoal.domain.QBigGoal bigGoal;
    ...
    public QBigGoalReview(Class<? extends BigGoalReview> type, PathMetadata metadata, PathInits inits) {
        ...
        this.bigGoal = inits.isInitialized("bigGoal") ? new com.sh.year.domain.goal.goal.biggoal.domain.QBigGoal(forProperty("bigGoal"), inits.get("bigGoal")) : null;
    }
